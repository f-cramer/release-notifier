...
class BsToSeriesService(
    ...
    companion object {
        ...
        private val SERIES_URL_REGEX = """https?://(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,}/serie/([^/]+)/([^/]+)/?""".toRegex()
        private val SEASON_URL_REGEX = """https?://(?:[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,}/serie/([^/]+)/(\d+)/([^/]+)/?""".toRegex()
